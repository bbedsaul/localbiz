...
// ---------------------------------------------------------------------------
// SiteVitals scan contract — ScanResult and its dependent types. The report
// generator, worker, and web all consume ScanResult; it lives in core so they
// need not import the engine package. sitevitals-engine re-exports these.
// ---------------------------------------------------------------------------
